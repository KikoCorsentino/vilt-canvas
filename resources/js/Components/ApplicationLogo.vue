...
<template>
    <div
        class="flex items-center font-bold text-xl text-primary-500 dark:text-primary-300 transition-colors duration-200"
        :style="{
    ...
    >
        ...
        >
            <!-- VILT Canvas Logo - Simple geometric design -->
            <g fill="currentColor">
        ...
        <span class="text-text-primary">VILT Canvas</span>
    </div>
</template>
